<?php
namespace Ma27\Jira\IssueVoteBundle\EventListener;
...
class JiraCredentialsListener implements EventSubscriberInterface, ContainerAwareInterface
{
     ...
     * @var \Ma27\Jira\IssueVoteBundle\Util\OAuthSecurityProxy
     */
    private $proxy;
    ...
    public function onHttpRequest(GetResponseEvent $event)
    {
        ...
        /** @var \Ma27\Jira\IssueVoteBundle\Util\OAuthPluginFactory $factory */
        ...
        if ($this->proxy->hasToken() && $session->has(static::OAUTH_LOGIN_FLAG)) {
            /** @var \Ma27\Jira\IssueVoteBundle\Entity\OAuthToken $tokens */
