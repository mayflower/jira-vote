...
class IssueReportedIterator extends AbstractIterator
{
    /**
     * @var Session
     */
    ...
    {
        return true === $this->session->get(IssueController::DISABLE_REPORTED_ID);
    }
    ...
    public function accept()
    {
        ...
        return $current->getReporter() !== $this->attributes->get('consumer')->getName();
    }
}
